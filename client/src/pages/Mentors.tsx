      ...
      <main style={{ maxWidth: 1280, margin: "0 auto", padding: "clamp(3rem, 6vw, 6rem) clamp(1.5rem, 6vw, 8rem)" }}>
        ...
        <RevealSection>
          <WIPBlock
            ...
            note="Mentors intro — their role, expertise areas, how they support the brand — work in progress"
            isDark={isDark}
          />
        </RevealSection>
        ...
        {/* Specialism filter placeholders */}
            ...
            {specialisms.map((s) => (
              <div
                ...
                style={{
                  ...
                  transition: "color 450ms cubic-bezier(0.23,1,0.32,1), border-color 450ms cubic-bezier(0.23,1,0.32,1)",
                }}
              >
                {s} — Add prompt here
              </div>
        ...
        <RevealSection delay={120}>
          ...
          >
            {Array.from({ length: 8 }).map((_, i) => (
              <WIPBlock
                key={i}
                label={`Mentor ${i + 1} — Add prompt here`}
                note="Portrait, name, specialism, bio — work in progress"
                tall
                isDark={isDark}
              />
            ))}
